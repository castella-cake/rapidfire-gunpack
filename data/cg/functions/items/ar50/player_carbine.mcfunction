...
execute if score @s cg.ar50.burst matches 1.. if score @s cg.ar50.ammo matches 1.. run function cg:items/ar50/se_shot_carbine
execute if score @s cg.ar50.burst matches 1.. if score @s cg.ar50.ammo matches 1.. run function cg:items/recoil/ar50_carbine
...
execute if entity @s[tag=!cg.ar50.reload] run title @s actionbar [{"text":"","color":"gold"},{"text":"== AR50-Carbine "},{"score":{"name":"@s","objective":"cg.ar50.ammo"},"color":"white"},{"text":" / "},{"score":{"name":"@s","objective":"cg.ammo_mid"},"color":"gray"},{"text":" BST |"},{"nbt":"text","storage":"cg:actionbar","interpret":true}]
execute if entity @s[tag=cg.ar50.reload] run title @s actionbar [{"text":"","color":"red"},{"text":"== AR50-Carbine "},{"score":{"name":"@s","objective":"cg.ar50.ammo"},"color":"white"},{"text":" / "},{"score":{"name":"@s","objective":"cg.ammo_mid"},"color":"gray"},{"text":" RLD |"},{"nbt":"text","storage":"cg:actionbar","interpret":true}]