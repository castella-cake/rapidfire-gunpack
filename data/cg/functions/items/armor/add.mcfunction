...
execute store result entity @e[sort=nearest,limit=1,tag=cg.armor.armorstand] ArmorItems[2].tag.Damage int 1 run scoreboard players operation @s cg.armor.damage += @s cg.armor.value
