...
execute unless predicate cg:select/charged unless entity @s[tag=cg.quickround.reload] unless score @s cg.quickround.delay matches 2.. run item modify entity @s weapon.mainhand cg:crossbow_arrow
...
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 3 run playsound block.iron_door.open player @a ~ ~ ~ 1 2 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 25 run playsound block.lever.click player @a ~ ~ ~ 0.8 1.1 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 28 run playsound item.crossbow.loading_end player @a ~ ~ ~ 0.8 1.7 0
...
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 30 run playsound item.armor.equip_gold player @a ~ ~ ~ 1 1.2 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 32 run playsound block.chain.break player @a ~ ~ ~ 0.5 1.2 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 33 run playsound block.chain.break player @a ~ ~ ~ 0.5 0.8 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 50 run playsound item.crossbow.loading_end player @a ~ ~ ~ 1 1.2 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 50 run playsound item.armor.equip_gold player @a ~ ~ ~ 1 1.5 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 50 run playsound item.armor.equip_iron player @a ~ ~ ~ 1 1.5 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 70 run playsound block.iron_door.close player @a ~ ~ ~ 1 1.8 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 70.. if score @s cg.ammo_mid matches ..5 run scoreboard players operation @s cg.quickround.ammo += @s cg.ammo_mid
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 70.. if score @s cg.ammo_mid matches ..5 run scoreboard players set @s cg.ammo_mid 0
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 70.. if score @s cg.ammo_mid matches 6.. run scoreboard players add @s cg.quickround.ammo 6
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 70.. if score @s cg.ammo_mid matches 6.. run scoreboard players remove @s cg.ammo_mid 6
execute if entity @s[tag=cg.quickround.reload] if score @s cg.quickround.rld_timer matches 70.. run tag @s remove cg.quickround.reload
execute if score @s cg.quickround.rld_timer matches 70.. run scoreboard players reset @s cg.quickround.rld_timer
