...
playsound entity.firework_rocket.blast master @a[distance=..35] ~ ~ ~ 1 1.8 0.1
playsound entity.firework_rocket.blast master @a[distance=..35] ~ ~ ~ 1 1.3 0.1
playsound entity.firework_rocket.blast master @a[distance=..35] ~ ~ ~ 1 0.8 0.1
playsound entity.firework_rocket.blast master @a[distance=..35] ~ ~ ~ 1 0.2 0.1
playsound entity.generic.explode master @a[distance=..35] ~ ~ ~ 0.5 1.7 0.1
playsound block.glass.break master @a ~ ~ ~ 0.1 1.5 0
